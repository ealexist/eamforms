...
## Environments
- Preview: https://main--eamforms--ealexist.hlx.page/
- Live: https://main--eamforms--ealexist.hlx.live/
...
1. Open the `eamforms` directory in your favorite IDE and start coding :)
